export class Commun {
     ...
     */
    static createShader(gl, vertexSource, fragmentSource) {
    ...
    static initalPoint(gl, program, size = 10.0, location = new Float32Array([0.0, 0.0, 0.0])) {
